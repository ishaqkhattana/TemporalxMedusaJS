...
exports.purchase = exports.NotifyConsumer = exports.updateInternalState = exports.capturePayment = exports.verifyCardDetails = void 0;
var activity_1 = require("@temporalio/activity");
function verifyCardDetails() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.log("Card Details verified!");
            return [2 /*return*/, activity_1.Context.current().info.activityId];
        });
    });
}
exports.verifyCardDetails = verifyCardDetails;
...
function purchase(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            console.log("Purchased ".concat(id, "!"));
            return [2 /*return*/, activity_1.Context.current().info.activityId];
        });
    });
}
